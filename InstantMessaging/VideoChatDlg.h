...
protected:
	...
	afx_msg LRESULT WaveOutOpen( WPARAM wParam, LPARAM lParam ) ;
	afx_msg LRESULT WaveOutDone( WPARAM wParam, LPARAM lParam ) ;
	afx_msg LRESULT WaveOutClose( WPARAM wParam, LPARAM lParam ) ;
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
