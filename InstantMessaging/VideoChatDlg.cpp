...
LRESULT CVideoChatDlg::WaveOutOpen( WPARAM wParam, LPARAM lParam )
{
	return 1;
}

LRESULT CVideoChatDlg::WaveOutDone( WPARAM wParam, LPARAM lParam )
{
	if( m_bReceiveAudio )
	{
		/// 播放追上接收
...
LRESULT CVideoChatDlg::WaveOutClose( WPARAM wParam, LPARAM lParam )
{
	return 1;
}
