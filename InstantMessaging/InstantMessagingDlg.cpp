...
LRESULT CInstantMessagingDlg::OnHotkey( WPARAM wParam, LPARAM lParam )
{
...
LRESULT CInstantMessagingDlg::OnShellNotifyProc( WPARAM wParam, LPARAM lParam )
{
...
void CInstantMessagingDlg::DeleteHistory( int nIndex, const CString strHistory )
{
	...
	for( nIndex = 1; nIndex <= nCount; nIndex++ )
	{
		...
		if( strHistory == strHistoryIP )
		{
			...
			int nIndex1;
			for( nIndex1 = nIndex + 1; nIndex1 <= nCount; nIndex1++ )
			{
...
LRESULT CInstantMessagingDlg::WaveInOpen( WPARAM wParam, LPARAM lParam )
{
...
LRESULT CInstantMessagingDlg::WaveInData( WPARAM wParam, LPARAM lParam )
{
...
LRESULT CInstantMessagingDlg::WaveInClose( WPARAM wParam, LPARAM lParam )
{
